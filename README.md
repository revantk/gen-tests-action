...
- If you are using Docker images as part of your CI/CD worflow, you can run test generation in a Docker image with the requisite dependencies for your project. To do this, add a `container` section under `jobs` in your worflow YAML file.
```
jobs:
  gen-tests:
    ...
